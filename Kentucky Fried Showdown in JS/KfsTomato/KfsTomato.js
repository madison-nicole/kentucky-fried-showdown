...
export default class KfsTomato extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("kfs tomato", "./KfsTomato/costumes/kfs tomato.png", {
        x: 480,
        y: 360
      })
    ];

    this.sounds = [new Sound("wahhh", "./KfsTomato/sounds/wahhh.wav")];
